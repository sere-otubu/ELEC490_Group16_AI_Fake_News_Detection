...
RAG_PROMPT_TEMPLATE = PromptTemplate(
    ...
    "---------------------\n"
    "EVALUATION CRITERIA:\n"
    "1. VERDICT: Label the claim as [TRUE] or [FALSE].\n"
    "2. EVIDENCE: Explain clearly how you came to your VERDICT. Provide specific text evidence from the CONTEXT to support your VERDICT.\n"
    "3. CITATIONS: Cite the file name that you used to arrive at your VERDICT.\n\n"
